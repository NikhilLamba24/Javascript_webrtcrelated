...
async function startViewer(localView, remoteView, formValues, onStatsReport, onRemoteDataMessage) {
    ...
    viewer.peerConnection.addEventListener('track', event => {
        ...
        viewer.remoteStream = event.streams[0];// this stream is passed to recognition model, perform the face recognition model here
        remoteView.srcObject = viewer.remoteStream; //remoteView is assigned a video
    });
